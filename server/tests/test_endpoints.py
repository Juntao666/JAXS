...
# @patch('data.manus.manus.read', autospec=True, return_value={
...
#
#
# @patch('data.manus.manus.read_one', autospec=True, return_value={
...
#
#
# @patch('data.manus.manus.read_one', autospec=True, return_value=None)
